...
$query = "SELECT `subscriptions`.*, `courses`.`name`, `courses`.`course_img`,`students`.`first_name`, `students`.`last_name`, `students`.`profile_img` , `statuses`.`name` AS `status_name`
            FROM `subscriptions` 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div>Are you sure, you want to delete this subscription.</div>
                </div>
