            ...
            <div class="content-body">
                <div class="card m-auto">
                    <div class="card-content pt-2">
                        <div class="card-body">
                            <?php
                            if (!is_null(mysqli_num_rows($results)) && mysqli_num_rows($results) > 0) {
                            ?>
                                <div class="text-center mb-2">
                                    <a href="buyAll.php" class="btn btn-success">Buy All</a>
                                </div>
                            <?php
                            }
                            ?>
                                        ...
                                        <?php while ($subscription = mysqli_fetch_assoc($results)) { ?>
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <div style="min-width: max-content;">
                                                        <a href="buyOne.php?id=<?= $subscription['id'] ?>" class="btn btn-success btn-sm text-white">
                                                            Buy
                                                        </a>
