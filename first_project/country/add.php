...
$title = 'Courses4U - Add New Country';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_SESSION['errorMessages'])) {
        $insertQuery = "INSERT INTO `countries`(`name`) VALUES (?)";
        ...
        if ($stmt) {
            ...
            $_SESSION['successMessages'] = 'New Country Added successfully';
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="col-12 text-center my-2">
                    <h2 class="text-white font-weight-bold">Add New Country</h2>
                </div>
            </div>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="offset-md-3 col-md-6 form-group text-center">
                                            ...
                                            <input type="text" id="Name" class="form-control" placeholder="Enter Country Name" name="name" value=<?= isset($_SESSION['oldData']['name']) ? '"' .  $_SESSION['oldData']['name'] . '"' : "" ?>>
